...
## Routing
- Primary DOCX specialization.
- Use this skill when the request is DOCX-native (layout fidelity, `.docx` editing, print-quality formatting).
- For non-DOCX documentation tasks, prefer `document-writer`.
