...
export ATLAS_CLI="$AGENT_SKILLS_HOME/atlas/scripts/atlas_cli.py"
```
...
Read `references/atlas-data.md` in the skill folder (for example, `$AGENT_SKILLS_HOME/atlas/references/atlas-data.md`) when adjusting data paths or timestamps.
